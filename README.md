...
* `!act TARGET MSG` - [admin] send `MSG` as a [CTCP `ACTION` message](http://www.mirc.org/mishbox/reference/ctcpref.htm) (as generated by `/me` in most IRC clients) to `target`.
